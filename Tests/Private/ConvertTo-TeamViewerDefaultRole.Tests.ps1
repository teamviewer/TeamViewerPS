BeforeAll {
    ...
    . (Join-Path -Path $Module_PrivCmdletsPath -ChildPath 'ConvertTo-TeamViewerDefaultRole.ps1')
}

Describe 'ConvertTo-TeamViewerDefaultRole' {
    It 'Returns an object for pipeline input' {
        ...
        $Result = $InputObject | & ConvertTo-TeamViewerDefaultRole
    ...
    It 'Supports pipeline processing of multiple items' {
        ...
        $Result = $InputObjects | & ConvertTo-TeamViewerDefaultRole
